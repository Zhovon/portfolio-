                        ...
                        <div className="space-y-10">
                            <div className="flex items-center gap-8 group">
                                ...
                                <div>
                                    ...
                                    <div className="text-xl font-bold text-white">admin@zhovon.com</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-8 group">
                                ...
                                <div>
                                    ...
                                    <div className="text-xl font-bold text-white">71, Sayed Nagar, Dakshin Khan, Dhaka 1230</div>
                                </div>
                            </div>
                        </div>

                        <div className="flex gap-6 mt-20">
                            <Link href="https://github.com/Zhovon" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass-panel rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:scale-110 transition-all">
                                <Github className="w-5 h-5" />
                            </Link>
                            <Link href="https://www.linkedin.com/in/shahadat-hossain-b314601b2/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass-panel rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:scale-110 transition-all">
                                <Linkedin className="w-5 h-5" />
                            </Link>
                            <Link href="https://www.facebook.com/shahadathossai.shovon" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass-panel rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:scale-110 transition-all">
